...
eje2.plot(res_conex['SWATPlus']['total_aqu_a%flo_cha'].vals)
eje2.set_title('Runnoff into channels (m^3)')

eje3.plot(res_conex['SWATPlus']['2_yield'].vals)
eje3.set_title('Banana Yield (t)')

eje4.plot(res_conex['SWATPlus']['4_yield'].vals)
eje4.set_title('Corn Yield (t)')

eje5.plot(res_conex['SWATPlus']['banana_land_use_area'].vals)
eje5.set_title('Banana Cultivation Area (ha)')
eje5.set_xlabel('Years')

eje6.plot(res_conex['SWATPlus']['corn_land_use_area'].vals)
